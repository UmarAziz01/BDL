...
public class FormPelanggan extends javax.swing.JFrame {
    ...
    public void loadDataPelanggan() {
        ...
        Collections.sort(pelangganList, Comparator.comparingInt(Pelanggan::getId_pelanggan));
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        try {
            int id = Integer.parseInt(tfIDPelanggan.getText());
...
//        crud.infoBegin();
//        hasilInfo.setText(String.copyValueOf(crud.infoBegin()));
