...
public class FormProduk extends javax.swing.JFrame {
    ...
    public void loadDataProduk() {
        ...
        Collections.sort(listProduk, Comparator.comparingInt(Produk::getId_produk));//mengurutkan
        tableModel.setColumnIdentifiers(new Object[]{"ID", "Nama", "Harga"});

        for (Produk n : listProduk) { //for(nama class...
            tableModel.addRow(new Object[]{n.getId_produk(), n.getNama(), n.getHarga()});
        }
    }
...
//            Double harga = Double.valueOf(tfHargaProduk.getText());
//
//            if (crud.updateProduk(id, nama, harga)) {
...
//        }
    ...
    private void cariData() {
       try {
            int id = Integer.parseInt(tfCari.getText().trim());
            Produk m = crud.cariDataByIdProduk(id); // nama class
            // Tampilkan hasil pencarian
            tableModel.setRowCount(0); // Clear table
            tableModel.addRow(new Object[]{m.getId_produk(), m.getNama(), m.getHarga()});

            tfIDProduk.setText(String.valueOf(m.getId_produk()));
            tfNamaProduk.setText(String.valueOf(m.getNama()));
